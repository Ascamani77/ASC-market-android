...
// Compatibility shim: provide androidx.compose.material.icons.autoMirrored.outlined.* symbols
// Map them to Icons.Outlined.* so code can reference AutoMirrored Outlined icons
...
// Education / navigation icons
val School: ImageVector get() = Icons.Outlined.School
val AutoGraph: ImageVector get() = Icons.Outlined.AutoGraph
