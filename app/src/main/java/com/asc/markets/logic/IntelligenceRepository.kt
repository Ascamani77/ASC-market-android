...
class IntelligenceRepository {
    ...
    fun getIntelligenceEvents(): Flow<List<IntelligenceEvent>> = flow {
        ...
        // Initial mock data mirroring IntelligenceEvent structure
        events.addAll(listOf(
            IntelligenceEvent(
                ...
                event_type = IntelligenceEventType.policy,
                ...
                ebc = IntelligenceExecutionBoundaryContract(
                    status = IntelligenceEBCStatus.BLOCKED,
                ...
                transition_triggers = listOf(
                    IntelligenceTransitionTrigger("LIQUIDITY_THRESHOLD", "met"),
                    IntelligenceTransitionTrigger("YIELD_CURVE_STABILITY", "pending"),
                    IntelligenceTransitionTrigger("VOLATILITY_INDEX_DROP", "met")
                ),
                ...
                safety_gate = true,
                unlock_state = IntelligenceUnlockState.LOCKED,
            ...
            IntelligenceEvent(
                ...
                ebc = IntelligenceExecutionBoundaryContract(
                    status = IntelligenceEBCStatus.PERMITTED,
                ...
                transition_triggers = listOf(
                    IntelligenceTransitionTrigger("CPI_THRESHOLD", "met"),
                    IntelligenceTransitionTrigger("PIVOT_PROBABILITY", "met"),
                    IntelligenceTransitionTrigger("RECOVERY_SIGNAL", "pending")
                ),
                ...
                safety_gate = false,
                unlock_state = IntelligenceUnlockState.HARD_UNLOCK,
