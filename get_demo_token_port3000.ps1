# Get cTrader Demo Token - Using Port 3000
# Alternative port since 8080 is in use

Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  cTrader DEMO Token - Port 3000" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    Write-Host ""
    Write-Host "Try closing apps or use a different port." -ForegroundColor Yellow
    pause
    exit 1
}
...
Write-Host ""
Write-Host "⏳ Waiting for authorization (timeout: 5 minutes)..." -ForegroundColor Yellow
Write-Host ""
